...
Transferfuksjonen for kretsen den totale kretsen blir
\begin{equation}
...
Etter å ha satt $R_3$ og $R_4$ til de utregnede verdiene og manuelt tuna ble målingen som vist i \autoref{fig:posisjon_sagtann}. Her ser vi at målingen omtrent er i intervallet (\SI{1}{\volt}, \SI{5}{\volt}). Årsaken til at grafen ser ut som en sagtannbølge er at potensiometeret roterer rundt og motstanden i potensiometeret syker gradvis, til den har rotert en runde og da er den på maksimum motstand.
