...
Ved bruk av operasjonsforsterkerens gyldne regler, blir transferfunksjonen til $OP3$ $-\frac{1}{(R_5 + R_6) C_1} \int^t e(\tau) d\tau$ \cite{Johnson}.
...
\begin{equation}
    ...
    V_m =
    \frac{R_2}{R_1} \frac{R_8 + R_9}{R_7} \left(e + \frac{1}{(R_5 + R_6) C_1} \int^t e(\tau) d\tau \right),
\end{equation}
