...
Ved bruk av operasjonsforsterkerens gyldne regler, blir transferfunksjonen til $OP3$ $-\frac{1}{(R_5 + R_6) C_1} \int e dt$.
$OP4$ summerer spenningen fra $OP2$ og $OP3$ og forsterker resultatet med $K_p$.
Transferfunksjonen for $OP4$ er $-\frac{R_8 + R_9}{R_7}(v_2 + v_3)$, der $v_2$ er spenningen ut av $OP2$ og $v_3$ er spenningen ut av $OP3$. Ut fra dette kommer et uttrykk for $K_p$ og $T_i$ som vist i \ref{eq:K_p_og_T_i}.
...
Da motoren ble bremset med en finger, økte både pådraget og stasjonæravviket når intergratorleddet var skrudd av. Ved bruk av integratorleddet, økte pådraget helt til tilstanden nådde referanseverdien.
